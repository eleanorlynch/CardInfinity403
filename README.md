...
4) Make sure 'npm run dev' has been run and is still running (ie: that the server is still up). Open a new terminal window in the same directory and run 'npm run tunnel'.  
